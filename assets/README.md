...
- **Favicon:** copy `favicon.ico`, `favicon.svg` and `icon-32.png` into your public directory.
...
- **Source:** `hearthport-mark.svg`, `hearthport-wordmark.svg`, `github-readme-banner.svg`. The transparent mark works on a dark surface; use `hearthport-mark-on-dark.svg` when a background is required.
